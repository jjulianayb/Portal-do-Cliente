...
- Evidence + Recommendation Operational V1 começa em `BUILDING` na branch `feature/evidence-recommendation-operational-v1`, criada exatamente do head do PR #9. Após código e Build/typecheck, seguirá para `AUDIT`.
