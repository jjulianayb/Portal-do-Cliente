...
- Organizational Reading Engine V1 começa em `BUILDING` na branch `feature/organizational-reading-engine-v1`, criada exatamente do head do PR #8. Após código e Build/typecheck, seguirá para `AUDIT`.
