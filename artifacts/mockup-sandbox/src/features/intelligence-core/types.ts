...
export type IntelligenceSignal = { id: string; organization_id: string; employee_id?: string | null; signal_type: string; signal_family?: SignalFamily | null; signal_nature?: SignalNature | null; scope_type?: SignalScopeType | null; scope_ref?: string | null; direction?: SignalDirection | null; persistence?: SignalPersistence | null; impact_level?: SignalImpactLevel | null; sensitivity?: SignalSensitivity | null; window_start?: string | null; window_end?: string | null; context: Record<string, unknown>; observed_at: string; value: Record<string, unknown>; source_type: string; source_id?: string | null; status: SignalStatus; };
export type IntelligenceEvidence = { id: string; organization_id: string; signal_id?: string | null; evidence_type: EvidenceType; summary: string; payload: Record<string, unknown>; source_type: string; source_id?: string | null; observed_at?: string | null; relation: EvidenceRelation; independence_group?: string | null; };
