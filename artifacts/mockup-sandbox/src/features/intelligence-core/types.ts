...
export type IntelligenceRecommendationEvidence = { id: string; organization_id: string; recommendation_id: string; evidence_id: string; evidence_relation: RecommendationEvidenceRelation; context: Record<string, unknown>; created_at: string; };
