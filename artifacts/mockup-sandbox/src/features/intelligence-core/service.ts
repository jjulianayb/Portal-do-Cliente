...
export const readKnowledgeSources = (context: IntelligenceReadContext) => readTable(context, "knowledge_sources", selects.sources);
export const readKnowledgeDocuments = (context: IntelligenceReadContext) => readTable(context, "knowledge_documents", selects.documents);
